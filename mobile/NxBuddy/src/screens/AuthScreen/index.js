...
import { KeyboardAvoidingView, LayoutAnimation, Platform, StyleSheet, ImageBackground, UIManager } from 'react-native'
...
export default class AuthScreen extends Component {
  ...
  render () {
    const { isLoggedIn, isLoading, loginFailed, signup, login } = this.props
